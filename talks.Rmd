...
**December 20, 2020** As a cardiology fellow, we have clinical case conferences to review interesting or puzzling cases with evidence-based analysis. Here is an interesting case of [restrictive cardiomyopathy](http:://asshah4-github.io/patient-log/cases/12-14-20_biatrial-enlargement/biatrial-enlargement.html), including the work-up and a brief differential on etiologies.
...
**December 23, 2020** A brief overview of [cardiac tamponade](https://asshah4.github.io/patient-log/cases/12-23-20_pocus-cardiac-tamponade/pocus-cardiac-tamponade.html) for the POCUS curriculum for internal medicine residents.
